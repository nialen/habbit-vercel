...
const navigationItems = [
  { name: "首页", href: "/", icon: IoHomeSharp, color: "text-blue-500" },
  { name: "习惯管理", href: "/habits", icon: IoStarSharp, color: "text-yellow-500" },
  { name: "AI顾问", href: "/advisor", icon: IoRocketSharp, color: "text-purple-500" },
  { name: "亲子活动", href: "/activities", icon: IoHeartSharp, color: "text-pink-500" },
  { name: "数据统计", href: "/statistics", icon: IoBarChartSharp, color: "text-green-500" },
  { name: "奖励兑换", href: "/rewards", icon: IoGiftSharp, color: "text-orange-500" },
  { name: "家长社区", href: "/community", icon: IoPeopleSharp, color: "text-indigo-500" },
  { name: "通知中心", href: "/notifications", icon: IoNotificationsSharp, color: "text-red-500" },
  { name: "个人设置", href: "/settings", icon: IoSettingsSharp, color: "text-gray-500" },
]

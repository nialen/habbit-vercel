      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-glass px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-purple-100 text-sm font-medium">习惯养成</span>
          </div>
          <h1 className="text-gradient text-4xl md:text-5xl font-bold mb-4">习惯管理</h1>
          <p className="text-white/80 text-lg max-w-2xl mx-auto">培养良好习惯，成就美好未来 🌱</p>
        </div>
            ...
            <TabsContent value="my-habits" className="space-y-6">
              ...
              {showAddForm && (
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 shadow-lg">
                  ...
                  <div className="flex gap-3 mt-6">
                    ...
                    <Button variant="outline" onClick={() => setShowAddForm(false)} className="btn-secondary">
                      取消
                    </Button>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {habits.map((habit) => {
                  ...
                  return (
                    <div key={habit.id} className="card-modern">
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-12 h-12 ${categoryConfig.bgColor} rounded-2xl flex items-center justify-center text-xl border-2 ${categoryConfig.borderColor} shadow-sm`}
                          >
                            {habit.icon}
                          </div>
                          <div>
                  ...
                  return (
                    <div key={index} className={`card-modern`}>
                      <div className="flex items-center gap-3 mb-4">
                        <div
                          className={`w-14 h-14 ${categoryConfig.bgColor} rounded-2xl flex items-center justify-center text-2xl border-2 ${categoryConfig.borderColor} shadow-lg`}
                        >
                          {defaultHabit.icon}
                        </div>

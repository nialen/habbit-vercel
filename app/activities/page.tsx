...
export default function ActivitiesPage() {
  ...
  return (
    <PageLayout bg="bg-neutral-100">
      {/* 页面标题 */}
      <div className="mb-8">
        <div className="flex flex-col gap-1">
          <h1 className="text-2xl font-semibold text-gray-900">亲子活动提案</h1>
          <p className="text-sm text-gray-500">精心设计的亲子时光，让成长更有趣 🎨</p>
        </div>
      </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            <Button
              ...
              className={selectedAge === "全部年龄" ? "bg-blue-500 text-white shadow-md" : ""}
            >
              全部年龄
            </Button>
            {ageGroups.map((age) => (
              <Button
                ...
                className={selectedAge === age.value ? "bg-blue-500 text-white shadow-md" : ""}
              >
                {age.label}
              </Button>
            ))}
          ...
          <div className="flex flex-wrap gap-2">
            {categories.map((category) => (
              <Button
                ...
                className={selectedCategory === category ? "bg-blue-500 text-white shadow-md" : ""}
              >
                {category}
              </Button>
            ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredActivities.map((activity) => (
          <div key={activity.id} className="card-modern hover:shadow-md transition-all duration-200">
